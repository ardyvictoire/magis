...
class Docter_table(admin.ModelAdmin):
    list_display = ("id", "names", "email", "phone_numb", "adress", "birthday_date", "speciality", "user", "password", "created_at", "created_by", "udapte_at", "delete_at")
    search_fields = ["names", "email"]

# Register Clients
@admin.register(Client)
class Client_table(admin.ModelAdmin):
    list_display = ("id", "names", "email", "phone_numb", "adress", "birthday_date", "examen_id", "user", "docter_id", "created_at", "created_by", "udapte_at", "delete_at")
    search_fields = ["names", "email"]
...
class Exam_table(admin.ModelAdmin):
    list_display = ("name_examen", "prix", "description", "created_at", "created_by", "udapte_at", "delete_at")
...
class Result_table(admin.ModelAdmin):
    list_display = ("id", "exam", "result", "result_creat_at", "created_at", "created_by", "udapte_at", "delete_at")
...
class Comment_table(admin.ModelAdmin):
    list_display = ("id", "result", "docter", "comments", "created_at", "created_by", "udapte_at", "delete_at")
...
class Ordonnanc_table(admin.ModelAdmin):
    list_display = ("id", "docter", "ordonnanc_creat_at", "created_at", "created_by", "udapte_at", "delete_at")
