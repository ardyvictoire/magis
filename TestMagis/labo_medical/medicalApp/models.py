...
class Resultat(models.Model):
    id_examen = models.ForeignKey(Examen, on_delete=models.CASCADE, related_name='resultats')
    resultat = models.TextField()
    date_resultat = models.DateField()

# les donnees de la table commentaire du medecin a propos des resultat 
class Comment(models.Model):
    id_resultat = models.ForeignKey(Resultat, on_delete=models.CASCADE, related_name='comments')
    id_medecin = models.ForeignKey(Medecin, on_delete=models.CASCADE, related_name='comments')
    comments = models.TextField()

# les donnees de la table Ordonnance
class Ordonnance(models.Model):
    id_client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='ordonnance')
    id_medecin = models.ForeignKey(Medecin, on_delete=models.CASCADE, related_name='ordonnance')
