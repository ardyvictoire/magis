...
class Examen_form(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'name_examen' : forms.TextInput(attrs={'class' : 'form-control', 'autocomplete' : 'off'}),
            'prix' : forms.NumberInput(attrs={'class' : 'form-control', 'autocomplete' : 'off'}),
...
class Resultat_form(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'id_exame' : forms.Select(attrs={'class' : 'form-control', 'autocomplete' : 'off'}),
            'resultat' : forms.TextInput(attrs={'class' : 'form-control', 'autocomplete' : 'off'}),
            'date_resultat' : forms.DateInput(attrs={'class' : 'form-control', 'autocomplete' : 'off'}),
        }
...
class Comment_form(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'id_resultat' : forms.Select(attrs={'class' : 'form-control', 'autocomplete' : 'off'}),
            'id_medecin' : forms.Select(attrs={'class' : 'form-control', 'autocomplete' : 'off'}),
            'comments' : forms.Textarea(attrs={'class' : 'form-control', 'autocomplete' : 'off'}),
        }
...
class Ordonnance_form(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'id_client' : forms.Select(attrs={'class' : 'form-control', 'autocomplete' : 'off'}),
            'id_medecin' : forms.Select(attrs={'class' : 'form-control', 'autocomplete' : 'off'}),
            'date_ordonnance' : forms.DateInput(attrs={'class' : 'form-control', 'autocomplete' : 'off'}),
        }