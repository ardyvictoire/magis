...
urlpatterns = [
    ...
    path("delete_data_comment/<int:id>/", views.delete_data_comment, name='delete_data_comment'),
    path("delete_data_ordonn/<int:id>/", views.delete_data_ordonn, name='delete_data_ordonn'),
    path("delete_data_examen/<int:id>/", views.delete_data_examen, name='delete_data_examen'),
    path("delete_data_result/<int:id>/", views.delete_data_result, name='delete_data_result'),
]
